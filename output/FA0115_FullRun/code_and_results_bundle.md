...
- `python src/reproduce.py --spec spec.json --config configs/reproduction_config.json --output results/reproduction_metrics.json`

## Result Summary

The code bundle contains a runnable fallback scaffold plus honest partial-result artifacts.
...
## File: `configs\reproduction_config.json`
